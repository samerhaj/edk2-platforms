  ...
  )
{
  ...
  MmioWrite32 (RegBase + BCM2711_INTC_TIMER_CONTROL_OFFSET, 0);
}
  ...
  )
{
  ...
  MmioOr32 (RegBase + BCM2711_INTC_TIMER_CONTROL_OFFSET, 1 << Source);
  ...
  )
{
  ...
  MmioAnd32 (RegBase + BCM2711_INTC_TIMER_CONTROL_OFFSET, ~(1 << Source));
  ...
  )
{
  ...
  *InterruptState = (MmioRead32 (RegBase + BCM2711_INTC_TIMER_CONTROL_OFFSET) &
                     (1 << Source)) != 0;
  ...
  )
{
  ...
  RegVal = MmioRead32 (RegBase + BCM2711_INTC_TIMER_PENDING_OFFSET) &
    ((1 << NUM_IRQS) - 1);
